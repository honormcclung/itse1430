...
namespace Lab1
{
    internal class Program
    {
        static void Main ( string[] args )
        {
            ...
            do
            {
                chosenOption = ChooseMenuOption(hasMadeOrder, computerParts);
                ...
                {
                    NewOrder(computerParts, processors, processorPrices, memory, memoryPrices, primaryStorageOptions,
        ...
        static void DisplayMenuOptions (Boolean hasMadeOrder, List<String> computerParts)
        {
            Console.WriteLine();
        ...
        static String ChooseMenuOption (Boolean hasMadeOrder, List<String> computerParts)
        {
            string menuOption; 

            do
            {
                DisplayMenuOptions(hasMadeOrder, computerParts);
        ...
        static List<String> NewOrder (List<String> computerParts, String[] processors, double[] processorPrices, 
